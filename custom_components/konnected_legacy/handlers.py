...
async def async_handle_state_update(hass, context, msg):
    ...
    async_dispatcher_send(hass, f"konnected_legacy.{entity_id}.update", state)
...
async def async_handle_temp_update(hass, context, msg):
    ...
    if entity_id:
        async_dispatcher_send(hass, f"konnected_legacy.{entity_id}.update", temp)
...
async def async_handle_humi_update(hass, context, msg):
    ...
    if entity_id:
        async_dispatcher_send(hass, f"konnected_legacy.{entity_id}.update", humi)
